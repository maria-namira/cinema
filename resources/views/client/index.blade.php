...
@section('content')
    ...
    <main>
        ...
        <section class="movie">
            <div class="movie__info">
                <div class="movie__poster">
                    <img class="movie__poster-image" alt="Альфа постер" src="{{ asset('client/images/poster2.jpg') }}">
                </div>
                <div class="movie__description">
        ...
        <section class="movie">
            <div class="movie__info">
                <div class="movie__poster">
                    <img class="movie__poster-image" alt="Хищник постер" src="{{ asset('client/images/poster2.jpg') }}">
                </div>
                <div class="movie__description">
