            ...
            <div class="popup__wrapper">
                <form action="{{ route('add_movie') }}" method="post" accept-charset="utf-8">
                    ...
                    <label class="conf-step__label conf-step__label-fullsize" for="movie-name">
                        Название фильма
                        <input class="conf-step__input" type="text" placeholder="Например, &laquo;Гражданин Кейн&raquo;" name="movie-name">
                    </label>
                    <label class="conf-step__label conf-step__label-fullsize" for="movie-duration">
                        Длительность фильма
                        <input class="conf-step__input" type="text" placeholder="110" name="movie-duration">
                    </label>
                    <label class="conf-step__label conf-step__label-fullsize" for="movie-description">
                        Описание фильма
                        <input class="conf-step__input" type="text" placeholder="Описание фильма" name="movie-description">
                    </label>
